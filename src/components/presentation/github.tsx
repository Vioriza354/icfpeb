      ...
      <div className="container mx-auto">
        ...
        >
          <CardBody className="py-20 px-14 md:w-7/12">
            ...
            >
              Let's join us for a better future!
            </Typography>
            <Typography variant="lead" color="white">
            Become a pioneering faculty and excel in the implementation of Islamic economics-based economics and business discipline education.
            </Typography>
            <a href="">
