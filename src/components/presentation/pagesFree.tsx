...
const posts = [
  {
    ...
    desc: "The Islamic economics and finance study program focuses on the study and development of the fields of Islamic economics, Islamic finance and banking, Islamic business and entrepreneurship, and Islamic philanthropy (Zakat and Waqf).",
    url: "https://ieki.upi.edu/",
  },
  {
    img: "akt.jpg",
    title: "Accounting",
    desc: "To become a leading accounting study program in Indonesia that plays a role in national development and is internationally recognized",
    url: "https://akuntansi.upi.edu/",
  },
  {
    img: "404.jpg",
    title: "Management",
    desc: "For you who want to learn managerial competencies to develop and improve international enterprises in multicultural settings, Bachelor of Management open the enrollment for International Business—a double-degree program. No matter where you come from, you are eligible to join this prestigious opportunity.",
    url: "ht",
  },
];
        ...
        <div className="container mx-auto px-8 py-10">
          <div className="mb-16 text-left">
            ...
            <Typography color="blue-gray">
              You can start seeing our website if you want to get inspired or show something.
            </Typography>
          </div>
